...
class OpenCampusApiChannel extends ApplicationChannel
  ...
  Future prepare() async {
    ...
    final config = OpenCampusApiConfiguration(options.configurationFilePath);
...
class OpenCampusApiConfiguration extends Configuration {
  OpenCampusApiConfiguration(String fileName) : super.fromFile(File(fileName));
