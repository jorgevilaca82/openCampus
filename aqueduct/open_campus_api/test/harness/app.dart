import 'package:open_campus_api/model/user.dart';
import 'package:open_campus_api/open_campus_api.dart';
import 'package:aqueduct_test/aqueduct_test.dart';

export 'package:open_campus_api/open_campus_api.dart';
export 'package:aqueduct_test/aqueduct_test.dart';
export 'package:test/test.dart';
export 'package:aqueduct/aqueduct.dart';

/// A testing harness for open_campus_api.
///
...
///         }
///
class Harness extends TestHarness<OpenCampusApiChannel> with TestHarnessAuthMixin<OpenCampusApiChannel>, TestHarnessORMMixin {
  @override
